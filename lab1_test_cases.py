...
class TestLab1(unittest.TestCase):
    ...
    def test_bin_search_last(self):
        ...
        self.assertEqual(bin_search(10, 0, len(list_val_odd)-1, list_val_odd), 8)
    ...
    def test_bin_search_mixed(self):
        list_val_odd_mixed = [-7, -4, 0, 1, 2, 3, 5, 7, 11]
        list_val_even_mixed = [-7, -4, 0, 1, 2, 3, 5, 7]

        self.assertEqual(bin_search(0, 0, len(list_val_odd_mixed) - 1, list_val_odd_mixed), 2)
        self.assertEqual(bin_search(3, 0, len(list_val_even_mixed) - 1, list_val_even_mixed), 5)
